...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    do {
    //     if (empty($titrequizz) || empty($difficulte) || empty($question1) || empty($q1rep1) || empty($q1rep2) || empty($q1rep3) || empty($q1rep4) || empty($q1bonnerep) || empty($question2) || empty($q2rep1) || empty($q2rep2) || empty($q2rep3) || empty($q2rep4) || empty($q2bonnerep) || empty($question3) || empty($q3rep1) || empty($q3rep2) || empty($q3rep3) || empty($q3rep4) || empty($q3bonnerep) || empty($question4) || empty($q4rep1) || empty($q4rep2) || empty($q4rep3) || empty($q4rep4) || empty($q4bonnerep) || empty($question5) || empty($q5rep1) || empty($q5rep2) || empty($q5rep3) || empty($q5rep4) || empty($q5bonnerep) || empty($question6) || empty($q6rep1) || empty($q6rep2) || empty($q6rep3) || empty($q6rep4) || empty($q6bonnerep) || empty($question7) || empty($q7rep1) || empty($q7rep2) || empty($q7rep3) || empty($q7rep4) || empty($q7bonnerep) || empty($question8) || empty($q8rep1) || empty($q8rep2) || empty($q8rep3) || empty($q8rep4) || empty($q8bonnerep) || empty($question9) || empty($q9rep1) || empty($q9rep2) || empty($q9rep3) || empty($q9rep4) || empty($q9bonnerep) || empty($question10) || empty($q10rep1) || empty($q10rep2) || empty($q10rep3) || empty($q10rep4) || empty($q10bonnerep)) {
